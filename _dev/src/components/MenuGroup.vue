...
<Collapsable>
  ...
  <template v-slot:header="props">
    ...
    <MenuItem @click="changeState(element)" class="w-full" :id="id" :element="element" :config="config" :title="title" :icon="icon">
  ...
  <template v-slot:content> 
    <slot></slot>
    <ButtonLight v-if="element.can_repeat"
      icon="PlusCircleIcon"
      @click.prevent="pushEmptyState(id_prettyblocks)"
