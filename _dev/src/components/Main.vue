...
<div class="bg-white shadow overflow-hidden sm:rounded-lg">
  ...
  <div class="flex mx-auto pt-4">
    ...
    <div class="w-full border h-full ">
      <iframe id="website-iframe" sandbox="allow-same-origin  allow-scripts allow-forms" class="w-full h-screen px-8" src="https://cartzillaps.alwaysdata.net/" frameborder="0"></iframe>
    </div>
